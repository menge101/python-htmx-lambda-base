...
class Cookie:
    ...
    def __init__(
        ...
        *,
        ...
        self.path = path
        self.secure = secure
        # It is very important to note that same_site being None and being the string literal "None"
        # are not the same, are not meant to be the same, and should not be confused for each other
